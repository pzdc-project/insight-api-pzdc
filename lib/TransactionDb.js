...
var encodedData = require('soop').load('pzdccore-js/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('pzdccore-js/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('pzdccore-js/lib/Address', {
...
TransactionDb.prototype.getValueOut = function(txid, cb) {
  var self = this;
